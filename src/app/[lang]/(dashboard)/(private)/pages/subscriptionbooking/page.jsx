...
//   return (
//     <Card>
//       <CardHeader title='Booking Subscription' />
//       <Divider />
...
//   // If the booking type is not subscription, return N/A
//   if (sts?.toLowerCase() !== 'subscription') return 'N/A'
  
//   // If no booking date, return N/A
//   if (!bookingDate) return 'N/A'
  
//   // Parse the booking date (format: DD-MM-YYYY)
...
//   let effectiveSubscriptionType = subscriptionType?.toLowerCase() || 'monthly'
  
//   // Calculate subscription end date based on type
//   let endDate = new Date(startDate)
//   switch (effectiveSubscriptionType) {
//     case 'weekly':
...
//       break
//     default:
//       // Default to monthly for unspecified subscription types
//       endDate.setMonth(startDate.getMonth() + 1)
//       break
//   }
...
//             row.original.parkingDate || row.original.bookingDate,
//             row.original.subsctiptiontype,
//             row.original.sts
//           )
          
//           // If not applicable, return N/A with gray color
//           if (daysLeft === 'N/A') {
//             return <Typography variant="body2" sx={{ color: '#666' }}>N/A</Typography>
//           }
          
//           // Set color based on days left
//           const color = daysLeft === 'Expired' ? '#ff4d49' : 
//                         daysLeft.startsWith('0') ? '#fdb528' :
//                         parseInt(daysLeft) <= 3 ? '#fdb528' : '#72e128'
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('subscriptionLeft', {
        header: 'Subscription Left',
        cell: ({ row }) => {
          // For subscription bookings, calculate days left
          ...
          // If not a subscription booking, show N/A
